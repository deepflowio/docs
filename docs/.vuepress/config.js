...
module.exports = ({
  ...
  // patterns: ['**/*.md', '**/*.vue', '**/*.json', '**/*.txt'],

  locales: {
    "/": {
      lang: "en-US",
      title: "DeepFlow (Community) Docs",
      description: "",
    },
    '/zh/': {
      lang: 'zh-CN',
      title: 'DeepFlow (Community) 文档',
      description: ''
    },
  },
  ...
  head: [
    ...
    //   'script',
    //   {
    //     src: 'https://cdn.bootcdn.net/ajax/libs/clipboard.js/2.0.9/clipboard.js',
    //   },
    // ],
  ],
  ...
  // 插件配置
  plugins: [
    // require("./plugins/love-me/index.js"),
