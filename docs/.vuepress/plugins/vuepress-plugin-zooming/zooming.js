  ...
  var target = {
    ...
    calculateTranslate: function calculateTranslate() {
      ...
      var targetCenter = {
        ...
        x: (windowCenter.x/(window.YS_ZOOM || 1) - targetCenter.x),
        y: (windowCenter.y/(window.YS_ZOOM || 1) - targetCenter.y)
      };
    },
    calculateScale: function calculateScale() {
      ...
      if (!customSize && zoomingHeight && zoomingWidth) {
        ...
        return {
          x: scale/(window.YS_ZOOM || 1),
          y: scale/(window.YS_ZOOM || 1)
        };
      }
    }
  };
  ...
  var Zooming = function () {
    ...
    createClass(Zooming, [{
      ...
      value: function open(el) {
        ...
        if(typeof this.options.onBeforeOpen === 'string') {
          window[this.options.onBeforeOpen](target$$1);
        }else {
