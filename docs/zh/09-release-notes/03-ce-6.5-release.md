...
- Agent
  - HTTP2 解析性能提升，在限定 deepflow-agent 1 逻辑核的情况下，极限 TPS 采集性能提升 6 ~ 15 倍，测试数据见下表

| 采集的 Header 数量 | 版本   | Agent CPU | Agent Memory | HTTP2 客户端 TPS | 采集 TPS |
| ------------------ | ------ | --------- | ------------ | ---------------- | -------- |
| 2                  | old    | 96%       | 34 MB        | 10K              | 10K      |
|                    | new    | 96%       | 197 MB       | 58K              | 58K      |
| 11                 | old    | 95%       | 8 MB         | 2K               | 2K       |
|                    | new    | 97%       | 222 MB       | 30K              | 30K      |
