...
helm install deepflow -n deepflow deepflow/deepflow --version 6.6.017 --create-namespace
```
...
EOF
helm install deepflow -n deepflow deepflow/deepflow --version 6.6.017 --create-namespace -f values-custom.yaml
```
