...
- **① 切换TOP数据:** 图表的基础操作，使用详情，请参阅【[流量拓扑 - 总览介绍](./02-topology.md)】章节
- **② 修改指标量:** 图表的基础操作，使用详情，请参阅【[流量拓扑](./02-topology.md)】章节
...
![04-line_2.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031165eedcfdc8b0e.png)
...
![04-line_2.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031165eedea337e3c.png)
