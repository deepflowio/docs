...
![08-table_3.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031965f8f90497a37.png)
...
![08-table_4.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031965f8fa17c876a.png)
...
- **③ 样式:** 对图表进行样式、颜色等设置
  - **样式:** 有丰富的功能支持对图表进行样式设置
    - **标题:** 支持修改图表名称
    - **单元格:** 支持设置表格复制功能的配置
      - 复制功能：开启，则数据项支持复制；关闭，则不支持复制
      - 复制内容：跟进需求选择要复制的数据内容
        - 复制数据：仅复制当前单元格的数据内容，即`value`
        - 正向筛选条件：复制内容格式为`key: value`
        - 正向筛选条件：复制内容格式为`key!: value`
...
![08-table_1.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031965f8f7906c908.png)
...
![08-table_2.png](https://yunshan-guangzhou.oss-cn-beijing.aliyuncs.com/pub/pic/2024031965f8f792e72e8.png)
