...
deepflowK8sClusterID: "d-xxxxxxxxxx"  # Optional: Kubernetes ClusterID in the DeepFlow Cloud
clusterNAME: "k8s-cluster-1" # Optional: Kubernetes cluster name in the DeepFlow Cloud
image:
