...
deepflowK8sClusterID: "d-xxxxxxxxxx"  # Mandatory for standalone Kubernetes cluster. Filling with the Kubernetes ClusterID which could be found in DeepFlow Cloud.
